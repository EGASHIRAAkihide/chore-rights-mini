...
export function MarkPaidButton({ instructionId }: MarkPaidButtonProps) {
  ...
  return (
    <div className="space-y-1">
      <button
        ...
        onClick={handleClick}
        disabled={disabled}
        className="inline-flex items-center rounded-md border border-slate-200 px-3 py-1 text-xs font-medium text-slate-600 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-400 disabled:cursor-not-allowed disabled:opacity-60"
